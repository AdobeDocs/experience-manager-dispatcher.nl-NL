...
description: Release-aantekeningen die specifiek zijn voor Adobe Experience Manager Dispatcher.
...
* DISP-944 - URL&#39;s van vooraf laden
...
* DISP-749 - Alpine Linux® Dispatcher loopt vast met het niveau van het spoorlogboek.
...
* DISP-826 - Steunt terugwinning van URIs met een vraagkoord
...
* DISP-742 - Geblokkeerde verzoeken kunnen informatie aan auth controleren-protected middelen lekken
...
* DISP-714 - Cookie-Gebaseerd zittingsbeheer werkt niet in IIS
...
* DISP-723 - impliciete onderbreking van 10 minuten (en probeer opnieuw) wanneer Render onderbreking die aan 0 wordt geplaatst
...
* DISP-693 - Update Architecturale details voor servers Solaris™ op de de downloadpagina van de Dispatcher
...
* DISP-705 - Dispatcher crashte als gevolg van dubbele vrijheid of corruptie (`fasttop`)
* DISP-706 - Tijdens ongeldigverklaring, volgt de Verzender achterverwijzingssymlinks die een oneindige lijn kunnen veroorzaken
